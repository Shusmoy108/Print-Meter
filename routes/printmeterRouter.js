...
Handlebars.registerHelper("designpage", function(design) {
  ...
  let top =
    ...
    "</div>" +
    "<div class='col-xs-5' style='font-size:20px'>Machine Number : 5</div>" +
    "</div></div>";
  var jobid = "";
  jobid =
    jobid +
  ...
  let sign =
    ...
    "<div class='col-xs-1'><form  action='/designs/print' method='get'><button type='submit'><span class='glyphicon glyphicon-list'></span></button></form></div>\n" +
    "</div></div>";
  ...
  var options = {
    format: "letter",
    base: "File:///D:/6-11-2018 printMeter/Print-Meter/public/",
    // width: "865px",
    // height: "1222px",
    zoomFactor: 0.5
  };
...
Handlebars.registerHelper("designtable", function(designs) {
  ...
  for (let i = 0; i < designs.length; i++) {
    jobpage =
      ...
      designs[i]._id +
      "' method='get'><button type='submit'><span class='glyphicon glyphicon-list'></span></button></form>" +
      "</td></tr>";
  }
